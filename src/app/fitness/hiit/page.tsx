...
function Content() {
  ...
  const work = Number(params.get("work")) || 40;
  const rest = Number(params.get("rest")) || 20;
  ...
  return (
    <TimerPage
      ...
      config={config}
      label="HIIT Timer"
      description="Configurable high-intensity interval training. Adjust work, rest, and rounds to match your fitness level."
      show_skip
      below={
