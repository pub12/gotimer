...
const RELATED_TIMERS = [
  ...
  { name: "11-Minute Cold Protocol Timer", href: "/wellness/contrast-therapy/11-minute-cold-protocol", description: "Post-workout contrast therapy — 3 rounds of sauna and cold plunge, ends on cold" },
