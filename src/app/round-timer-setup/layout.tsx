...
export const metadata: Metadata = {
  title: "Round Timer Setup - GoTimer",
  description:
    "Set up a round timer for tournament play. Track total time and individual round durations. Perfect for strategy games like Twilight Imperium.",
  alternates: {
  ...
  openGraph: {
    title: "Round Timer Setup - GoTimer",
    description:
      "Set up a round timer for tournament play. Track total time and individual round durations.",
