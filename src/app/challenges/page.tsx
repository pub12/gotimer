    ...
    <>
      ...
      <div className="w-full bg-gradient-to-br from-primary to-primary/80 py-10 md:py-16 px-6">
        <div className="max-w-screen-2xl mx-auto text-center">
          <h1 className="text-3xl md:text-5xl font-headline font-black text-primary-foreground mb-4">
            <Trophy className="inline w-8 h-8 md:w-10 md:h-10 text-secondary mr-2 align-middle" />
            Game Challenges
          </h1>
        ...
        {!authenticated && !auth_loading && (
          <>
            ...
            <div className="mb-8">
              ...
              <div className="bg-card rounded-[1rem] p-6 shadow-[var(--shadow-soft)] mb-6">
                ...
                <ScoreDisplay
                  ...
                  draws={2}
                />
                <div className="mt-2 p-3 rounded-[0.75rem] text-center text-sm font-medium bg-accent/10 text-accent">
            ...
            <div className="text-center py-8">
              <div className="bg-card rounded-[1rem] p-8 shadow-[var(--shadow-soft)]">
        ...
        {authenticated && (
          <>
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-headline font-black">Your Challenges</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-4">
              <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-accent font-headline font-black">1</span>
              </div>
            ...
            <div className="text-center p-4">
              <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-accent font-headline font-black">2</span>
              </div>
            ...
            <div className="text-center p-4">
              <div className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center mx-auto mb-2">
                <span className="text-accent font-headline font-black">3</span>
              </div>
...
function DemoCard({ name, my_wins, opponent_wins, draws, total_games }: {
  ...
  return (
    <div className="bg-card rounded-[1rem] shadow-[var(--shadow-soft)] p-4 hover:shadow-[var(--shadow-soft-lg)] transition-shadow">
...
function DemoGameRow({ winner, date, is_win, is_draw, notes }: {
  ...
  return (
    <div className={`p-3 rounded-[0.75rem] ${
      is_draw ? "bg-surface-container-high" : is_win ? "bg-accent/10" : "bg-surface-container-low"
    }`}>
      <div className="flex items-center justify-between">
