export const COLD_PLUNGE_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Research-relevant cold immersion happens at <strong>10-15&deg;C (50-59&deg;F)</strong>. Below 10&deg;C is genuinely cold-shock territory and benefits plateau quickly; above 15&deg;C the autonomic stress response is much weaker. Most home cold plunges and chillers target 4-12&deg;C. If you do not have a controlled tank, a cold shower set to its coldest setting (typically 12-18&deg;C from mains in winter) is a reasonable substitute for short rounds.",
  },
  {
    question: "Should I exhale or hold my breath in the cold?",
    answer:
      "<strong>Exhale slowly through pursed lips for the first 15-30 seconds.</strong> The cold-shock response triggers a forceful involuntary gasp; deliberate exhalation counteracts that reflex, lowers the chance of inhaling water, and helps the parasympathetic system regain control. After the initial shock passes, breathe slowly through your nose. Never hold your breath underwater in cold immersion — the breath-hold reflex combined with cold shock can cause loss of consciousness.",
  },
  {
    question: "Cold plunge before or after workout?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Cold-water immersion has real risks: cold shock can trigger arrhythmia in people with undiagnosed cardiac conditions; gasping reflex can cause aspiration; afterdrop (core temperature continuing to fall after exit) can lead to hypothermia if you stay cold too long. <strong>Do not cold plunge alone if you are new to it.</strong> Skip the plunge if you have uncontrolled hypertension, recent heart event, Raynaud&apos;s syndrome that has caused tissue damage, or are pregnant. Warm up gradually after exit — vigorous shivering for 5-10 minutes is normal and helpful.",
  },
];
